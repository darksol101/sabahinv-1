...
<body>
	...
	<table border="1" cellpadding="0" cellspacing="0" width="70%">
		<thead style="background:none repeat scroll 0 0 #49AB3C; color:#FFFFFF">
		...
		<?php
			...
			echo "<tr><td><strong>Total</strong></td><td>" . $currency . " <strong>" .  $entry_dr_total . "</strong></td><td>" . $currency . " <strong>" . $entry_cr_total . "</strong></td></tr>";
		?>
		</tbody>
	</table>
	<br />
