...
<body>
<div id="reportContent" style="height:500px; overflow:auto; margin:0;width:550px;">
	...
	<br />
	<table id="print-entry-table" width="100%">
		<thead>
	...
	<form>
	<input class="hide-print button" type="button" onClick="PrintReport()" value="Print entry">
	</form>
