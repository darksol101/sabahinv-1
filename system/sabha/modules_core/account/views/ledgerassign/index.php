        ...
        <table width="100%" class="tblgrid">
        	<col /><col width="60%" />
                <tbody>
                        <tr>
                                <td>
                                  <?php echo $servicecenter_filter;?>   
                                  <img src="<?php echo base_url();?>assets/style/img/icons/search.gif"	class="searchbtn"	onclick="javascript:$('#currentpage').val(0);getLedgerAssignList();" />   
                                </td>
