...
<h3 style="cursor: s-resize;"><?php echo $this->lang->line('balance_sheet');?></h3>
<ul class="content-box-tabs">
	<li><a class="default-tab" href="#tab1" id="account/report/balancesheet"><?php echo $this->lang->line('balance_sheet')?></a></li>
	<li><a class="" href="#tab1" id="account/report/profitandloss"><?php echo $this->lang->line('profit_and_loss_account')?></a></li>
	<li><a class="" href="#tab1" id="account/report/trialbalance"><?php echo $this->lang->line('trial_balance')?></a></li>
	<li><a class="" href="#tab1" id="account/report/ledgerst"><?php echo $this->lang->line('ledger_statement')?></a></li>
...
<?php
	...
	echo "<table border=0 class=\"balance-sheet-container\" width=\"100%\">";
	echo "<tr valign=\"top\">";

	$liability = new Accountlist();
	echo "<td width=\"" . $left_width . "\">";
	$liability->init(2);
	echo "<table border=0 cellpadding=5 class=\"simple-table balance-sheet-table tblgrid\" width=\"100%\">";
