...
<h3 style="cursor: s-resize;"><?php echo $this->lang->line('profit_and_loss_account');?></h3>
<ul class="content-box-tabs">
	<li><a class="" href="#tab1" id="account/report/balancesheet"><?php echo $this->lang->line('balance_sheet')?></a></li>
	<li><a class="default-tab" href="#tab2" id="account/report/profitandloss"><?php echo $this->lang->line('profit_and_loss_account')?></a></li>
...
<?php
	...
	echo "<table border=0 cellpadding=5 class=\"simple-table profit-loss-table tblgrid\" width=\"100%\">";
