...
<h3 style="cursor: s-resize;"><?php echo $this->lang->line('reconciliation');?></h3>
<ul class="content-box-tabs">
	...
	<li><a href="#tab4" id="account/report/ledgerst"><?php echo $this->lang->line('ledger_statement')?></a></li>
	<li><a class="default-tab" href="#tab4" id="account/report/reconciliation/pending"><?php echo $this->lang->line('reconciliation')?></a></li>
</ul>
<div class="clear"></div>
</div>
...
<?php
	...
	if ( ! $print_preview)
	{
		echo form_open('account/report/reconciliation/' . $reconciliation_type . '/' . $ledger_id);
		echo "<p>";
