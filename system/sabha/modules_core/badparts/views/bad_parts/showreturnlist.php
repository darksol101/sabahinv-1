...
<table class="tblgrid" cellpadding="0" cellspacing="0" width="100%">
	<col width="5%" /><col width="15%"/><col width="15%" /><col width="15%" /><col width="25%"/> <col width="5%" /><col width="15%" />
    <thead>
		...
		?>
			<tr<?php echo $trstyle;?>>
            	<td><?php echo $i;?></td>
                 ...
                 <td style="text-align:center"><?php if($list->signed == 0){?><input type="checkbox" class="return_list" id="<?php echo $list->badparts_engineer_details_id; ?>" value="<?php echo $list->badparts_engineer_details_id;?>"/><?php } 
