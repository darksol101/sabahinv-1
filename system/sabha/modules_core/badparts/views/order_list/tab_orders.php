...
<div class="toolbar1">
  <form onsubmit="return false;">
   ...
   <col width="25%" /><col width="15%" /><col width="15%" /><col width="15%" /><col width="15%" /><col />
   	<tr>
    	<td>Search <input type="text" name="searchtxt" id="searchtxt" value="" class="text-input" onkeydown="Javascript: if (event.keyCode==13) showOrderList();"  /></td>
	...
	class="searchbtn" onclick="showOrderList();" /> <span class="message"><span
