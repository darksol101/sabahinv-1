...
<?php
$this->load->model('badparts/mdl_badparts_order_parts_details');
...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	...
	<tr>
		...
		C.G.Electronics Pvt. Ltd. ( Chalan )</td>
		<td colspan="5"
        ...
        <tr style="height:auto;">
         <td style="font-size: 11px; text-align: left; border-width:0 1px!important; padding-left:10px; padding-top:5px; "><?php echo $i;?></td>
             ...
             <td style="font-size: 11px; text-align: left; border-width:0 1px!important; padding-left:10px; padding-top:5px;"><?php echo $orderpart->part_description;?></td>
              <td style="font-size: 11px; text-align: left; padding-left:10px; padding-top:5px; border-right:1px solid;"><?php echo $orderpart->part_sc_price;?></td>
             <td style="font-size: 11px; text-align: left; border-width:0 1px!important; padding-left:10px; padding-top:5px;"><?php $quantity = $this->mdl_order_parts_details-> getDispatchedPartByChalan($orderpart->order_part_id,$transit_id);  echo $quantity->part_quantity;?></td>
