<?php $this->load->view('calendar/calendar/script');?>
<style type="text/css">
#cal_wrapper{ position:relative}
#cal_wrapper .popup{position:absolute;left:0;top:-24px;background-color:#fff;color:red;font-family:Arial;font-weight:700;font-size:10pt;z-index:2;visibility:hidden;width:auto;min-width:200px;border-color:#000;border-style:solid;border-width:4px;padding:5px; margin-left:12px;}
...
<span onclick="ShowPop('cal');"><?php echo icon("nepali_calendar","Nepali Calendar","png");?></span>
<?php 
