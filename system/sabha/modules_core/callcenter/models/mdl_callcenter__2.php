...
$this->db->select('c.call_id,c.call_uid,c.call_dt,c.call_tm,cs.cust_first_name,cs.cust_last_name,ct.city_name,pm.model_number,en.engineer_name,c.call_dt AS call_aging,sc_name,c.call_status,c.call_serial_no,reopened,c.happy_status');
