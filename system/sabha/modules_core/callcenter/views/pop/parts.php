...
<table>
	<tr>
    	<td>Search : <input type="text" name="searchtxt" id="searchtxt" value="" class="text-input" onKeydown="Javascript: if (event.keyCode==13) { getcallpartlist(); }"/></td>
        <td> <img
	src="<?php echo base_url();?>assets/style/img/icons/search.gif"	class="searchbtn" onclick="getcallpartlist();" /> <span class="message"><span
	class="message_text"></span></span><span class="loading"><?php echo icon("loading","Loading","gif","icon");?></span></td>
    </tr>
</table>
</form>
</div>
<div id="getcallpartlist" style="display:none"></div>
