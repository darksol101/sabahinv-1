...
<ul class="content-box-tabs">
	...
	<li><a class="default-tab" href="#tab2"
		id="callcenter/callregistration"><?php echo $this->lang->line('callsetup')?></a></li>
</ul>
</div>
<div class="content-box-content">
<div id="tab1" class="tab-content"></div>
<div id="tab2" class="tab-contentdefault-tab"><?php $this->load->view('callregistration');?></div>
</div>
