...
class Cities extends Admin_Controller {
	...
	function index()
	{
		...
		$this->load->model(array('utilities/mdl_html','cities/mdl_cities','cities/mdl_zones','zones/mdl_districts','servicecenters/mdl_servicecenters'));
		...
		$servicecenter_search = $this->mdl_html->genericlist( $servicecenterOptions, "sc_search",array('class'=>'validate[required] text-input'));
