...
<div class="content-box-header">
  ...
  <ul class="content-box-tabs">
    ...
    <li><a class="default-tab" href="#tab3" id="cities"><?php echo $this->lang->line('city');?></a></li>
  </ul>
  <div class="clear"></div>
</div>
<div class="content-box-content">
  ...
  <div id="tab3" class="tab-content  default-tab"><?php $this->load->view('cities/tab_cities');?></div>
</div>
