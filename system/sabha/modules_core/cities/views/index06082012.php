<?php $this->load->view('dashboard/header', array("header_insert"=>"cities/script", "title"=>$this->lang->line('user_accounts'))); ?>
<div class="content-box-header">
  <h3 id="moduletitle" style="cursor: s-resize;">Store</h3>
  <ul class="content-box-tabs">
    <li><a href="#tab1" id="servicecenters">Store</a></li>
    <li><a class="default-tab" href="#tab2" id="cities">City</a></li>
  </ul>
  <div class="clear"></div>
</div>
