...
$(document).ready(function(){
    ...
    <col width="1%" /><col /><col width="15%" /><col width="15%" /><col width="15%" /><col width="1%" /><col width="5%" />
    	<thead>
        	<tr><th>S.No.</th><th>City</th><th>District</th><th>Zone</th><th>Store</th><th>&nbsp;</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
<?php
	$i=1;
	...
	?>
    		<tr <?php echo $trstyle;?>><td><?php echo $i+$page['start'];?></td><td><?php echo $city->city_name;?></td><td align="center"><?php echo $city->district_name; ?></td><td><?php echo $city->zone_name;?></a></td><td><?php echo $city->sc_name;?></td><td><a class="btn" onclick="showcity('<?php  echo $city->city_id; ?>')"><?php echo icon('edit','edit','png');?></a></td><td><a onclick="deletCity('<?php echo $city->city_id;?>')"><?php echo icon("delete","Delete","png");?></a></td></tr>
    <?php	
	$i++;
		}
?>
