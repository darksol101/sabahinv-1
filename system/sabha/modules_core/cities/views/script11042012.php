...
function savecity()
{
	...
	//var zone_id=$("#frmcity #zone_select").val();
	var district_id=$("#frmcity #district_select").val();	
	var hdncity_id=$("#hdncity_id").val();
	var params="city_id="+hdncity_id+"&city_name="+city_name+"&district_id="+district_id+"&unq="+ajaxunq();
	$.ajax({			
			type	:	"POST",
...
function showCityTable(){
	...
	var params="ajaxaction=getcitylist&searchtxt="+searchtxt+"&currentpage="+currentpage+"&zone_id="+zone_id+"&district_id="+district_id+"&unq="+ajaxunq();
	$.ajax({			
			type	:	"POST",
