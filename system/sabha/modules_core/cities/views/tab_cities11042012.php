...
<div class="toolbar1">
  ...
  <input type="text" name="searchcitytxt" id="searchcitytxt" class="text-input" value="" onKeydown="Javascript: if (event.keyCode==13) $('#currentpage').val(0);showCityTable();" /><span>&nbsp;&nbsp;<?php echo $zone_search;?></span>&nbsp;&nbsp;<span id="search_district_box"><?php echo $district_search;?></span>
