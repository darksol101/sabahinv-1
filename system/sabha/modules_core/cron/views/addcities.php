...
<table width="100%">
	...
	<tr>
		...
		<td>
		<div id="select_district_box"><?php echo $district_select; ?></div>
		</td>
		<th><label><?php echo $this->lang->line('city'); ?>: </label></th>
		<td><input type="text" name="city_name" id="city_name"
	...
	<tr>
		<td colspan="5"><input type="hidden" value="0" id="hdncity_id"
			name="hdncity_id" /> <input type="hidden" name="currentpage"
			id="currentpage" value="0" /> <input class="button" type="submit"
			value="<?php echo $this->lang->line('save'); ?>" name="btn_submit"
			id="btn_submit" onClick="" /> <input class="button" type="button"
			value="<?php echo $this->lang->line('cancel'); ?>" name="btn_cancel"
			id="btn_cancel" onclick="cancel()" /> <input type="button"
			value="<?php echo $this->lang->line('close'); ?>" name="btn_submit"
			id="btn_close_group" class="button" onclick="closeform();" /></td>
	</tr>
</table>
</form>
