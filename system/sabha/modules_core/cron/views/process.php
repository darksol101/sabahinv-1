...
<table style="width: 100%" cellpadding="0" cellspacing="0"
	...
	foreach ($cities as $city){
		...
		<tr <?php echo $trstyle;?>>
			...
			<td><?php echo $city->sc_name;?></td>
			<td><a class="btn"
				onclick="showcity('<?php  echo $city->city_id; ?>')"><?php echo icon('edit','edit','png');?></a></td>
			<td><a onclick="deletCity('<?php echo $city->city_id;?>')"><?php echo icon("delete","Delete","png");?></a></td>
		</tr>
		<?php
		$i++;
	}
