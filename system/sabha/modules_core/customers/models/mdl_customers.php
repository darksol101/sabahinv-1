...
class Mdl_Customers extends MY_Model {
	...
	public function getCustomers($page){
		...
		$this->db->select('cust_id,cust_first_name,cust_last_name,cust_address,cust_phone_home,cust_phone_office,cust_phone_mobile');
		$this->db->from($this->table_name);
		$this->db->order_by('cust_first_name ASC');
