...
<form onsubmit="return false" id="frmengineers">
  <table width="40%">
    ...
    <tr>
      ...
      <td><input type="text" value="" id="engineer_phone" name="engineer_phone" class="validate[custom[integer],maxSize[10]] text-input text-input"/></td>
    </tr>
    <tr>
    	<th><label><?php echo $this->lang->line('skill_qualification');?></label></th>
        <td><textarea type="text" id="skill_qualification" name="skill_qualification" class="text-input"></textarea></td>
    </tr>
    <tr>
