...
$(document).ready(function(){
    ...
    <col width="5%" /><col /><col width="1%" /><col width="1%" /><col width="1%" />
    	<thead>
        	<tr><th>S.No.</th><th>Engineer's Name</th><th></th><th style="text-align:center;">Status</th><th></tr>
        </thead>
        <tbody>
<?php
	$i=1;
	...
	?>
    		<tr <?php echo $trstyle;?>><td><?php echo $i+$page['start'];?></td><td><?php echo $engineer->engineer_name;?></td><td><a class="btn" onclick="showengineer('<?php echo $engineer->engineer_id;?>')"><?php echo icon("edit","Edit","png");?></a></td><td style="text-align:center;" ><a class="btn" onclick="changeEstatus('<?php echo $engineer->engineer_id;?>','<?php echo $engineer->engineer_status;?>');"><?php echo $status;?></a></td><td><a class="btn" onclick="deletEngineer('<?php echo $engineer->engineer_id?>')"><?php echo icon("delete","Delete","png");?></a></td></tr>
    <?php	
	$i++;
		}
?>
