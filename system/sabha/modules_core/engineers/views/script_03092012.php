...
function cancel(){
	...
	$("#engineer_name").val('');
	$("#engineer_phone").val('');
	$("#engineer_skill_qualification").val('');
	$("#engineer_desc").val('');
...
function showEngineerTable(){
	...
	var params="ajaxaction=getengineerlist&searchtxt="+searchtxt+"&sc_id="+sc_id+"&currentpage="+currentpage+"&unq="+ajaxunq()
	$.ajax({			
			type	:	"POST",
...
function showengineer(engineer_id){
	...
	$.ajax({			
			...
			success	:	function (data){
				...
				$("#engineer_phone").val(dt.engineer_phone);
				$("#engineer_skill_qualification").val(dt.engineer_skill_qualification);
...
function saveengineer(){
	...
	var engineer_phone=$("#engineer_phone").val();
	...
	var skill_qualification = $("#skill_qualification").val();
	var params="&engineer_id="+engineer_id+"&engineer_name="+engineer_name+"&engineer_phone="+engineer_phone+"&skill_qualification="+skill_qualification+"&engineer_desc="+engineer_desc+"&engineer_status="+engineer_status+"&sc_id="+sc_id+"&unq="+ajaxunq();
	$.ajax({			
			type	:	"POST",
