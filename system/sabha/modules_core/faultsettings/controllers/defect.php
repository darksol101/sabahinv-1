...
class Defect extends Admin_Controller {
	...
	function index()
	{
		...
		$symptom_search = $this->mdl_html->genericlist($sysmptomOptions,'symptom_search',array('class'=>''),'value','text','');
		...
		$product_search = $this->mdl_html->genericlist($productOptions,'product_search',array('onchange'=>'getsymptomsearch();'),'value','text','');
	...
	function getproductsbybrandsearch()
	{
		...
		$brandlist = $this->mdl_html->genericlist($brandOptions,'product_search',array('onchange'=>'getsymptomsearch();','class'=>'validate[required] text-input'),'value','text',$active);
		echo $brandlist;
	}
	function getsymptomsbyproductsearch(){
		...
		$sysmptomOptions = $this->mdl_symptom->getSymptomOptionsByProduct($product_id);
		array_unshift($sysmptomOptions, $this->mdl_html->option( '', 'All Symptom'));
		$symptom_select  =  $this->mdl_html->genericlist($sysmptomOptions,'symptom_search',array(),'value','text','');
		echo $symptom_select ;
	}
}
?>