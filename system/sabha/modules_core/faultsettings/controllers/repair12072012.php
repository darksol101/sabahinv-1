...
class Repair extends Admin_Controller {
	...
	function index()
	{
		...
		$this->load->model(array('utilities/mdl_html','faultsettings/mdl_symptom','faultsettings/mdl_defect'));
	...
	{
		$this->redir->set_last_index();
		$this->load->model(array('faultsettings/mdl_repair','faultsettings/mdl_symptom','faultsettings/mdl_defect'));
