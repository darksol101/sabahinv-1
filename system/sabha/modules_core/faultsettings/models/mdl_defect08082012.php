...
class mdl_Defect extends MY_Model {
	...
	public function getDefectlist($page)
	{
		...
		$this->db->select("$this->table_name.defect_id,$this->table_name.symptom_id,$table_symptom.symptom_code,$this->table_name.defect_code,$this->table_name.defect_description,$this->table_name.defect_status,$table_product.product_name");
