...
class mdl_Symptom extends MY_Model {
	...
	public function getSymptomCodeById($symptom_id)
	{
		$params = array(
						'select'=>'symptom_code',
	...
	{	
		...
		$this->db->select("$this->table_name.symptom_id,$this->table_name.symptom_code,$this->table_name.symptom_description,$this->table_name.symptom_status,".$this->mdl_products->table_name.".product_name,".$this->mdl_brands->table_name.'.brand_name');
