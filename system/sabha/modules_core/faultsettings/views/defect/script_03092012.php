...
function showdefectlist(){
	...
	var params="ajaxaction=getdefectlist&searchtxt="+searchtxt+'&product_id='+product_id+'&brand_id='+brand_id+'&symptom_id='+symptom_id+"&currentpage="+currentpage+"&unq="+ajaxunq();
	$.ajax({			
			type	:	"POST",
...
function getsymptomsearch(){
	loading("symptom_box_search");
	var product_id = $("#product_search").val();
	var params = 'product_id='+product_id+'&unq='+ajaxunq();
	$.ajax({			
			type	:	"POST",
			url		:	"<?php echo base_url();?>faultsettings/defect/getsymptomsbyproductsearch",
			data	:	params,
			success	:	function (data){
