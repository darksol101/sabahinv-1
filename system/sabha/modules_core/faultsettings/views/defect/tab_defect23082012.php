...
<div class="toolbar1">
  ...
  <table class="toolbox" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td><span id="product_box_search"><?php echo $product_search;?></span><img src="<?php echo base_url();?>assets/style/img/icons/search.gif" class="searchbtn" onclick="javascript:$('#currentpage').val(0);showdefectlist();" /></td>
