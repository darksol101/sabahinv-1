...
$(document).ready(function(){
    ...
    <col width="1%" /><col /><col /><col /><col /><col width="1%"/> <col width="1%" /><col width="1%"/>
    	<thead>
        	<tr><th>S.No.</th><th>Symptom Code</th><th>Description</th><th style="text-align:center">Brand</th><th style="text-align:center">Product</th><th>&nbsp;</th><th align="center">Status</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
...
?>
 		<tr <?php echo $trstyle;?>><td><?php echo $i+$page['start'];?></td>
            ...
            <td style="text-align:center"><?php echo $symptom->brand_name;?></td>
...
$(document).ready(function(){
    ...
    <col width="1%" /><col /><col /><col /><col /><col width="1%"/> <col width="1%" /><col width="1%"/>
    	<thead>
        	<tr><th>S.No.</th><th>Defect Code</th><th>Symptom Code</th><th>Brand</th><th>Product</th><th>Description</th><th>&nbsp;</th><th align="center">Status</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
...
?>
 		<tr <?php echo $trstyle;?>><td><?php echo $i+$page['start'];?></td>
            ...
            <td><?php echo $defect->brand_name;?></td>
            <td><?php echo $defect->product_name;?></td>
...
$(document).ready(function(){
	...
	?>
    <table style="width:100%" cellpadding="0" cellspacing="0" class="tblgrid">
    <col width="1%" /><col /><col /><col /><col /><col /><col width="1%"/> <col width="9%" /><col width="1%"/>
    	<thead>
        	<tr><th>S.No.</th><th><?php echo sorter('repair_code');?>Repair Code</th><th><?php echo sorter('defect_code');?>Defect Code</th><th><?php echo sorter('symptom_code');?>Symptom Code</th><th style="text-align:center"><?php echo sorter('brand_name');?>Brand</th><th style="text-align:center"><?php echo sorter('product_name');?>Product</th><th>&nbsp;</th><th align="center"><?php echo sorter('repair_status');?>Status</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
...
?>
 		<tr <?php echo $trstyle;?>><td align="center"><?php echo $i+$page['start'];?></td>
			...
			<td style="text-align:center"><?php  echo $repair->brand_name; ?></td>
            <td style="text-align:center"><?php  echo $repair->product_name; ?></td>
