...
$(document).ready(function(){
    ...
    <col width="1%" /><col /><col /><col /><col /><col width="1%"/> <col width="1%" /><col width="1%"/>
    	<thead>
        	<tr><th>S.No.</th><th>Defect Code</th><th>Symptom Code</th><th>Product Name</th><th>Description</th><th>&nbsp;</th><th align="center">Status</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
...
$(document).ready(function(){
    ...
    <col width="1%" /><col /><col /><col /><col /><col /><col width="1%"/> <col width="9%" /><col width="1%"/>
    	<thead>
        	<tr><th>S.No.</th><th><?php echo sorter('repair_code');?>Repair Code</th><th><?php echo sorter('defect_code');?>Defect Code</th><th><?php echo sorter('symptom_code');?>Symptom Code</th><th style="text-align:center"><?php echo sorter('product_name');?>Product</th><th style="text-align:center"><?php echo sorter('brand_name');?>Brand</th><th>&nbsp;</th><th align="center"><?php echo sorter('repair_status');?>Status</th><th>&nbsp;</th></tr>
        </thead>
        <tbody>
