...
<style type="text/css">
#product_box_search,#select_product_box,#select_symptom_box,#select_defect_box,#symptom_box_search,#defect_box_search{position:relative;}
#product_box_search .loading,#select_product_box .loading,#select_symptom_box .loading,#select_defect_box .loading,#symptom_box_search .loading,#defect_box_search .loading{position:absolute; left:0px; top:0; width:100%; height:30px; margin:0 auto; text-align:center;}
</style>
