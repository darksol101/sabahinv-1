...
<div style="width:650px;">
    <form id="fileupload" action="<?php echo site_url();?>manual/upload" method="post" enctype="multipart/form-data">
        <div class="row fileupload-buttonbar">
                	...
                	<tr>
                    	<td>
                            <span class="btn btn-success fileinput-button">
                                ...
                                <input type="file" name="files" class="btn browse" />
                            </span>
               		 	</td>
                        <td>
            ...
            <span id="uploadmsg" class="message" style="float:none;"></span>
        </div>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload fade">
		<td>Description:</td>
		<td><input type="text" value="" name="manual_description" value="" class="text-input"  /></td>
...
<script src="<?php echo base_url();?>assets/jquery/jquery.fileupload-ui.js"></script>
<script src="<?php echo base_url();?>assets/jquery/main.js"></script>
<script src="<?php echo base_url();?>assets/jquery/locale.js"></script>
<script> showManualList('<?php echo $model_id;?>');</script>
