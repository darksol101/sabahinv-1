...
<div class="toolbar1">
  <form onsubmit="return false;">
   ...
   <col />
	...
	class="searchbtn" onclick="showPopOrderList();" /> <span class="message"><span
	class="message_text"></span></span><span class="loading"><?php echo icon("loading","Loading","gif","icon");?></span></td>
      <td><input type="button" value="Add part" class="button" onclick="addcallpart();" /></td>
    </tr>
