    ...
    foreach($orderparts as $details){
        ...
        <tr<?php echo $trstyle;?>>
          ...
          <td style="text-align: center; "><input type="hidden" name="comp[]" value="<?php echo $details->company_title;?>" class="text-input" /><span class="lbl"><?php echo $details->company_title;?></span></td>
           ...
           <td style="text-align: center;"><input type="hidden" name="call[]" value="<?php echo $details->call_uid;?>" class="text-input" /><span class="lbl"><?php echo $details->call_uid;?></span></td>
           <td><?php echo $dispatched_quantity->dispatched_quantity; ?> </td>
           <td><?php echo $delivered_quantity->delivered_quantity;?> </td>
           <td><?php if ( $dispatched_quantity->dispatched_quantity - $delivered_quantity->delivered_quantity > 0){echo  $dispatched_quantity->dispatched_quantity - $delivered_quantity->delivered_quantity;}?> </td>
