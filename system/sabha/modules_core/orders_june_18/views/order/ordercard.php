        ...
        <tr style="">
         ...
         <tr>
             <td style="font-size: 11px; text-align: left;"><label>&nbsp;</label></td>
              <td style="font-size: 11px; text-align: left;"><label>&nbsp;</label></td>
              <td style="font-size: 11px; text-align: left;"><label>&nbsp;</label></td>
             <td  style="font-size: 11px; text-align: left; font-weight:bold; padding-left:10px"><label>Total Quantity:</label></td>
              <td style="font-size: 11px; text-align: left; padding-left:10px"><label> <?php echo number_format($unitprice,2);?></label></td>    
               <td style="font-size: 11px; text-align: left; padding-left:10px"><label> <?php echo number_format($total,2);?></label></td>    
