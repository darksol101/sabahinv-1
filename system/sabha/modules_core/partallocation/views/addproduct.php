...
<table width="75%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table>
			<tr>
				...
				<td><input type="text" value="" id="product_name"
					name="product_name" class="validate[required] text-input" /></td>
			</tr>
			<tr>
		...
		<table>
			<tr>
				<th style="vertical-align: middle;"><label><?php echo $this->lang->line('description'); ?>:
				</label></th>
				<td><textarea name="product_description" id="product_description"
					rows="2" cols="10" style="width: 200px;"></textarea></td>
			</tr>
			<tr>
	...
	<tr>
		<td align="right" colspan="2"><input type="submit"
			...
			id="btn_submit" class="button" /> <input type="button"
