...
<table cellpadding="0" cellspacing="0" width="100%" border="0" class="tblgrid">
    ...
    <tr>
    		<td style="text-align:left; font-size: 12px; padding:3px;"><b><?php echo $this->lang->line('part_status');?></b></td>
    		<td style="text-align:left; font-size: 12px; padding:3px;"><?php if($this->input->get('allco_select')==1){echo $this->lang->line('allocate');}else{echo $this->lang->line('revoke');}?></td>
    </tr>
    </table>
    ...
    <tr>
   		 <td style="text-align:left; font-size: 12px; padding:3px;"><b><?php echo $this->lang->line('allocated_revoked_date');?></b></td>
    	<td style="text-align:left; font-size: 12px; padding:3px;"><?php echo $this->input->get('searchdate');?>&nbsp;</td>
    </tr>
   </table>
	...
	foreach($lists as $list){ ?>
			...
			<tr>
                ...
                <td  style="text-align:left;border-width:0 1px ;font-size: 12px; padding-left:10px;"><?php echo $list->part_desc;?></td>
                 <td style="text-align:center;border-width:0 1px ;font-size: 12px;"><?php echo $list->quantity;?></td>
                 <!--<td style="text-align:center;border-width:0 1px font-size: 11px;;"><?php// if(($list->signed) == 0) { echo "Unsigned" ;}else { echo "Signed";}?>-->
                 </td>
