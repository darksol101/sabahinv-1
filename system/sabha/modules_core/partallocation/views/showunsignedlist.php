...
<col width="5%" /><col width="15%"/><col width="15%" /><col width="15%" /><col width="22%"/> <col width="10%" /><col width="5%" /><col width="15%" /><col width="5%" />
	<thead>
    <tr>
    <td colspan="9" style="text-align:right;"><input type="button" class="button" title="Download Report" value="<?php echo $this->lang->line('download');?>" onclick="downloadUnsignedReport();" /></td>
    </tr>
    <tr>
		...
		?>
			<tr<?php echo $trstyle;?>>
            	<td><?php echo $i;?></td>
                 ...
                 <td><a  title="Print Report" target="_self" href="<?php echo site_url();?>partallocation/allocationreport/<?php echo $list->sc_id;?>/<?php echo $list->engineer_id;?>/2/<?php echo $list->part_number;?>/<?php echo $list->created_date;?>/4/<?php echo $list->event;?>"><?php echo icon('print','Print','ico')?></a> </td>
           </tr>
	<?php $i++; }?>
    </tbody>
