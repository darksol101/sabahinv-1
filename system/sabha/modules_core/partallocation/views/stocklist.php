...
<table class="tblgrid" cellpadding="0" cellspacing="0" width="100%">
	<col width="1%" /><col width="20%"/><col width="20%" /><col width="10%" /><col width="15%"/><col width="10%" /><col width="5%" /><col width="10%" /><col width="40%" />
	<thead>
    	<tr>
	...
	foreach($stocklist as $stock){
		...
		?>
			<tr<?php echo $trstyle;?>>
                ...
                <td><a href="<?php echo site_url();?>stocks/stockdetails/<?php echo $stock->sc_id?>/<?php echo $stock->part_number?>/<?php echo $stock->company_id?>"><?php echo $stock->part_number?></a></td>
