...
<table>
	<tr>
    	<td>Search : <input type="text" name="searchtxt" id="searchtxt" value="" class="text-input" onKeydown="Javascript: if (event.keyCode==13) { getBinSearchList(); }"/></td>
        <td> <img title="Search Item"
	src="<?php echo base_url();?>assets/style/img/icons/search.gif"	class="searchbtn" onclick="getBinSearchList();" /> </td>
    </tr>
    <input type="hidden" id="pop_sc_id" value="<?php echo $sc_id;?>"/>
</table>
</form>
</div>
<div id="binsearchlist" style="display:none"></div>
