...
<table>
	<tr>
    	<td>Search : <input type="text" name="searchtxt" id="searchtxt" value="" class="text-input" onKeydown="Javascript: if (event.keyCode==13) { getPartSearchList(); }"/></td>
        <td> <img title="Search Parts"
	src="<?php echo base_url();?>assets/style/img/icons/search.gif"	class="searchbtn" onclick="getPartSearchList(<?php echo  $sc_id; ?>);" /> </td>
    </tr>
