...
<ul class="content-box-tabs">
	<li><a class="" href="#tab1" id="parts"><?php echo $this->lang->line('parts')?></a></li>
    <li><a class="default-tab" href="#tab2" id="parts/modelpartreport"><?php echo $this->lang->line('model_association')?></a></li>
</ul>
</div>
...
<?php $this->load->view('parts/modelpartreport');?>
