...
for ($i = 2; $i <= $row_count; $i++) {
    ...
    <tr<?php echo $trstyle;?>>
        ...
        <td style="text-align:center"><?php echo $rows[$i][4];?><input type="hidden" name="part_lp[]" value="<?php echo $rows[$i][4];?>" /></td>
        <td style="text-align:center"><?php echo $rows[$i][5];?><input type="hidden" name="part_cp[]" value="<?php echo $rows[$i][5];?>" /></td>
        <td style="text-align:center"><?php echo $rows[$i][6];?><input type="hidden" name="part_sp[]" value="<?php echo $rows[$i][6];?>" /></td>
