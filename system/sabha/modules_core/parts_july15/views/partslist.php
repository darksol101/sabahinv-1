	...
	foreach ($parts as $part){
		...
		<tr <?php echo $trstyle;?>>
			...
			<td style="text-align: center;">
				<img width="250" height="42" style="margin-top:10px;float:left;" src="<?php echo site_url('parts/barcodes?text='.$part->part_number);?>"/>
				
				<a class="printer" href="#" style="text-decoration:underline;" onclick="barcodes('<?php echo $part->part_number;?>','bar')"><strong>Barcode Printer</strong></a>
				<br>
				<br>
				<a class="printer" href="#" style="text-decoration:underline;" onclick="barcodes('<?php echo $part->part_number;?>','a4')"><strong>A4 Printer</strong></a>
				</span>
			</td>
