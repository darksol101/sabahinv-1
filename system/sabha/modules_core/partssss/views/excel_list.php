...
for ($i = 2; $i <= $row_count; $i++) {
	...
	if($rows[$i][2]){
		...
		if(strlen($rows[$i][2]) > 20){
			   $maxlength = true;
		}

		if($maxlength == true || $duplicate == true || $err == true){
	...
	?>
    <tr<?php echo $trstyle;?> <?php echo $style; ?> >
    	<td><?php echo $i-1;?></td>
        ...
        <?php
			...
			elseif ($maxlength == true) {
				echo '<span style="padding:0 1px;">Item Number Length Error</span>';
