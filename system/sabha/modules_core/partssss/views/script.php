...
function appendImages(no_of,img,price) {
	...
	else
	{
		...
		var style="width: 4.5cm;height: 2cm; margin:0 3.5mm 1mm 1mm;padding-top:11px;";
		var style1="width: 4.5cm;height: 2cm; margin:0 3.5mm 1mm 1mm;padding-top:11px;";
		var style2="width: 4.5cm;height: 2cm; margin:-2mm 3.5mm 1mm 1mm;padding-top:11px;";
		var style12="width: 4.5cm;height: 2cm; margin:-2mm 0 1mm 1mm;padding-top:11px;";
		var style3="width: 4.5cm;height: 2cm; margin:0 3.5mm 1mm 1mm;";
		var style31="width: 4.5cm;height: 2cm; margin:0 3.5mm 1mm 1mm;padding-top:11px;";

		var image='<div style="float:left;"><img style="'+style+'" src="<?php echo site_url();?>'+img+'">';
		var image1='<div style="float:left;"><img style="'+style1+'" src="<?php echo site_url();?>'+img+'">';

		var image2='<div style="float:left;"><img style="'+style2+'" src="<?php echo site_url();?>'+img+'">';
		var image12='<div style="float:left;"><img style="'+style12+'" src="<?php echo site_url();?>'+img+'">';

		var image3='<div style="float:left;"><img style="'+style3+'" src="<?php echo site_url();?>'+img+'">';
		var image31='<div style="float:left;"><img style="'+style31+'" src="<?php echo site_url();?>'+img+'">';
...
function barcodes (part_id,part_number,part_price) {

	$.facebox(function () {
		$.post('<?php echo site_url();?>parts/barcodes_print', { part_id:part_id,part_number:part_number, part_price:part_price,unq:ajaxunq()}, 
			function(data) {
				$.facebox(data); 
			});
	});
