...
<table width="100%" cellpadding="0" cellspacing="0" class="tblgrid toolbar1">
	...
	<tr>		
    	...
    	<td><label><?php echo $this->lang->line('part_quantity');?>:</label></td>
    		<td style="display:none;"><label><?php echo $this->lang->line('company');?>:</label>
        <td></td>
	</tr>
	<tr>
        ...
        <td><input type="text" name="part_quantity" id="part_quantity" value="" class="text-input validate[custom[onlyNumberSp]]"  /></td>
          ...
          <td style="display:none;"><?php echo $company_options;?></td>
...
<table width="100%" cellpadding="0" cellspacing="0" class="tblgrid">
	<col width="1%" /><col /><col width="20%" /><col width="30%" /><col width="10%" />
    <?php if($purchase->purchase_status == 0):?>
        <col width="5%" /><col width="1%" />
     <?php endif;?>
    <thead>
        <tr>
    		<th>Sno</th>  
            ...
            <th style="display:none;"><?php echo $this->lang->line('company');?></th>
        	<th></th>
            <?php if($purchase->purchase_status == 0):?>
                <th></th>
                <th></th>
    ...
    foreach($purchasedetails as $details){
		...
		<tr<?php echo $trstyle;?>>
            ...
            <td style="text-align: left; display:none;"><input type="hidden" name="comp[]" value="<?php echo $details->company_title;?>" class="text-input" /><span class="lbl"><?php echo $details->company_title;?></span></td>
           <td></td>
