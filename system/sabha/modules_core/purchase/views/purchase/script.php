...
$(document).ready(function(){
	$("#part_description").attr('readonly',true);
...
$(".datas").each(function() {	
		...
		var part_quantity = $(this).find('td:nth-child(4) ii').html();
		//var company = $(this).find('td:nth-child(4) ii').html();
		var company = "Default";
		var add = $(this).find('td:nth-child(7) select').val();


		/*var params=add+" "+part_number+" "+part_description+" "+company+" "+part_quantity;
