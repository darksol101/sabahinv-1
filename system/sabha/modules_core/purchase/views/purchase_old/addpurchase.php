...
<table width="100%">
    ...
    <tr>
        ...
        <td><input type="text" value="<?php echo $purchase->purchase_number;?>" id="purchase_number" name="purchase_number" class="validate[required] text-input" /></td>
    </tr>
    <tr>
    ...
    <th><label><?php echo $this->lang->line('purchase_date');?>:</label></th>
    	<td><input type="text" readonly="readonly" name="purchase_date" id="purchase_date" class="text-input datepicker" value="<?php echo format_date(strtotime(date("Y-m-d")));?>" style="width: 70%" /></td>
    </tr>
    <tr>
    ...
    <tr>
    	<th><label><?php echo $this->lang->line('deliver_status'); ?>:</label></th>
    ...
    <tr>
        ...
        <input type="button" value="<?php echo $this->lang->line('cancel'); ?>" name="btn_cancel"	id="btn_cancel" class="button" onclick="cancelform();" /><?php }?>
...
<table width="100%" cellpadding="0" cellspacing="0" class="tblgrid toolbar1">
	<col width="20%" /><col width="20%" /><col width="5%" /><col width="5%" /><col width="1%" />
	<tr>		
    	...
    	<td><label><?php echo $this->lang->line('part_rate');?>:</label></td>
        <td></td>
	</tr>
	<tr>
        ...
        <td><input type="text" name="part_rate" id="part_rate" value="" class="text-input" /></td>
        <td><input type="button" id="add_part" name="add_part" onclick="addpart();" value="Add" class="button" /></td>
	</tr>
</table>
<?php }?>
<table width="100%" cellpadding="0" cellspacing="0" class="tblgrid">
	<col width="1%" /><col /><col width="20%" /><col width="10%" /><col width="5%" /><?php if($purchase->purchase_status<1){?><col width="5%" /><col width="1%" /><?php }?>
    <tr>
		<th>Sno</th>  
        <th><?php echo $this->lang->line('part_no');?></th>
    	<th><?php echo $this->lang->line('part_quantity');?></th>
    	<th><?php echo $this->lang->line('part_rate');?></th> 
        <?php if($purchase->purchase_status<1){?><th></th> 
        <th></th><?php }?>
    </tr>
    <tbody id="rowdata">
    <?php 
    ...
    foreach($purchasedetails as $details){
		...
		<tr<?php echo $trstyle;?>>
            ...
            <td style="text-align: left;"><input type="hidden" name="prate[]" value="<?php echo $details->part_rate;?>" class="text-input" /><span class="lbl"><?php echo $details->part_rate;?></span></td>
