...
function showPurchaseList(){
	...
	var params='fromdate='+fromdate+'&todate='+todate+'&sc_id='+sc_id+'&vendor_name='+vendor_name+'&purchase_status='+purchase_status+"&currentpage="+currentpage+"&searchtxt="+searchtxt+"&unq="+ajaxunq();
	$.ajax({			
				type	:	"POST",
