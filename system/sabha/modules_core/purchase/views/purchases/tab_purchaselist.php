...
<table style="width:100%" class="toolbox" cellpadding="0"
	cellspacing="0">
	<col width="20%" /><col width="15%" /><col width="15%" /><col width="15%" /><col width="10%" /><col width="10%" /><col width="1%" /><col />
    <tr>
		...
		<td><img src="<?php echo base_url();?>assets/style/img/icons/search.gif" class="searchbtn" onclick="javascript:$('#currentpage').val(0);showPurchaseList();" /></td>
...
<div id="purchaselist" style="display:none"></div>
