...
class Dailyservicereport extends Admin_Controller {
	...
	function getreportslist()
	{
		...
		//Total number of pending calls with aging less than 2 days
		$reports['total_pending_less_than_2'] = $this->mdl_dailyservicereport->getTotalPendingCallsLess2();
		$reports['total_pending_between_2and7'] = $this->mdl_dailyservicereport->getTotalPendingCallsBetween2and7();
		$reports['total_pending_between_7and15'] = $this->mdl_dailyservicereport->getTotalPendingCallsBetween7and15();
		$reports['total_pending_between_15and30'] = $this->mdl_dailyservicereport->getTotalPendingCallsBetween15and30();
		$reports['total_pending_grater_than30'] = $this->mdl_dailyservicereport->getTotalPendingCallsGreaterthan30();
		
		//Total number of part pending calls with different range of time
		$reports['total_partpending_less_than_2'] = $this->mdl_dailyservicereport->getTotalPartPendingCallsLess2();
		$reports['total_partpending_between_2and7'] = $this->mdl_dailyservicereport->getTotalPartPendingCallsBetween2and7();
		$reports['total_partpending_between_7and15'] = $this->mdl_dailyservicereport->getTotalPartPendingCallsBetween7and15();
		$reports['total_partpending_between_15and30'] = $this->mdl_dailyservicereport->getTotalPartPendingCallsBetween15and30();
		$reports['total_partpending_grater_than30'] = $this->mdl_dailyservicereport->getTotalPartPendingCallsGreaterthan30();
		//Get name of Store
	...
	function senddailyreport(){
		if($this->input->post('sendmail')){
			...
			$data = array(
						  ...
						  'total_pending_less_than_2'=>$this->input->post('total_pending_less_than_2'),
						  'total_pending_between_2and7'=>$this->input->post('total_pending_between_2and7'),
						  'total_pending_between_7and15'=>$this->input->post('total_pending_between_7and15'),
						  'total_pending_between_15and30'=>$this->input->post('total_pending_between_15and30'),
						  'total_pending_grater_than30'=>$this->input->post('total_pending_grater_than30'),
						  'total_partpending_less_than_2'=>$this->input->post('total_partpending_less_than_2'),
						  'total_partpending_between_2and7'=>$this->input->post('total_partpending_between_2and7'),
						  'total_partpending_between_7and15'=>$this->input->post('total_partpending_between_7and15'),
						  'total_partpending_between_15and30'=>$this->input->post('total_partpending_between_15and30'),
						  'total_partpending_grater_than30'=>$this->input->post('total_partpending_grater_than30')
						  );
