...
class Engineerreport extends Admin_Controller {
	...
	function index()
	{
		...
		$servicecenter_select = $this->mdl_html->genericlist($servicecenterOptions,'brand_id',array('onchange'=>'getEngineerByScId($(this).val());','class'=>'validate[required] select-one','multiple'=>'multiple','style'=>'height:120px;'),'value','text',$b);
