...
class mdl_callreports extends MY_Model {
	...
	public function getCallReports($page)
	{
	...
	public function getCallReportExcel()
	{
		...
		$call_status = $this->input->post('cs');
	...
	public function getCallReportMail()
	{
		$cid=$this->input->post('cid');
		$cn=$this->input->post('cn');
		$pn=$this->input->post('pn');
		...
		$listdata['listdata'] = $result->result();
		/*echo '<pre>';
		print_r($listdata);
		die();*/	
		return $listdata;
