...
<div class="toolbar1" style="width:97%;">
  <form id="callForm" name="callForm" method="post" action="<?php echo base_url()?>reports/callhistory/searchcall">
  <table cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
    	<th style="vertical-align:middle;"><label><?php echo $this->lang->line('service_center');?></label></th>
        <td><?php echo $scenters;?></td>
               
    </tr>

 <tr>		<th> <label> <?php echo $this->lang->line('reopened');?></label></th>
			<td>			
