...
<link type="text/css" rel="stylesheet" href="<?php echo base_url();?>assets/style/css/excel_export.css" />

<div align="right">
<input type="button" title="Excel Download" name="button" class="button" value="<?php echo ($this->lang->line('excel_download'));?>" onclick="excelDownload();"/>
</div>
<div>&nbsp;</div>
...
<div
 ...
 <span>Total records : <strong><?php echo $config['total_rows'];?></strong></span>
 | <span><strong><?php echo $start;?> - <?php echo $end;?></strong></span><?php }?> |
