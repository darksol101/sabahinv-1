...
<table width="100%">
	...
	<tr>
		<th><label><?php echo $this->lang->line('from_sc');?>: </label></th>
		<td><?php echo $servicecenters_from; ?></td>
		<th><label><?php echo $this->lang->line('to_sc');?></label></th>
		<td><?php echo $servicecenters_to;?></td>
       ...
       <input class="button" type="submit"
			...
			title="Generate Order Report" onclick="showOrderReport();" /></td>
		</tr>
