...
<div class="toolbar1">
  <form onsubmit="return false" id="frmperformancereport" name="frmperformancereport">
    <table width="60%">
      <col width="12%" /><col width="20%" /><col width="10%" /><col width="20%" />
      <tr>
        <th><label><?php echo $this->lang->line('service_center');?>:</label></th>
        <td colspan="2"><?php echo $servicecenter_select;?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="5"><input class="button" type="submit" value="<?php echo $this->lang->line('generate_report'); ?>" name="btn_submit" id="btn_submit" onClick="getengineers_reportlist();" /></td>
      </tr>
    </table>
  </form>
</div>
