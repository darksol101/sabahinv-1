...
<table style="width: 100%;" cellpadding="0" cellspacing="0"	class="tblgrid" ">
	...
	<thead>
		<tr>
            ...
            <th><?php echo $this->lang->line('registered_date');?></th>
	...
	foreach($lists as $list):{
		...
		<tr <?php echo $trstyle;?>>
            ...
            <td><?php echo $list->cust_first_name .' '. $list->cust_last_name;?></td>
            <td><?php echo $list->product_name ;?></td>
            <td><?php echo $list->model_number ;?></td>
            <td><?php echo $list->sc_name ;?></td>
            <td><?php echo $list->engineer_name ;?></td>
            <td><?php echo $list->call_dt .' '.$list->call_tm ;?></td>
            <td><?php echo $list->closure_dt .' '. $list->closure_tm ;?></td>
            <td> </td>
		</tr>
		<?php
		$i++;
