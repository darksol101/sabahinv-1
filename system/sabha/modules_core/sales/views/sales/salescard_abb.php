...
<div id="cardContent" style="overflow: auto; margin: 0;">
<?php 
/*change TEJ*/
		$sales_type_name = Modules::run('sales/sales/getSalesType', $sales_id);
...
<p style="text-align:center;padding:0px !important;line-height:0.6; margin-top: -10px; font-size:14px;"><?php echo "Customer Copy"; ?></p>
</div>
<?php $this->load->view('sales/sales/salescard_abb_partial',$data);?>
 <p style="text-align:center;padding:0px !important;line-height:0.6; margin-top: -10px; font-size:14px;"><?php echo "Store Copy"; ?></p>
</div>
 <div>
</div>
