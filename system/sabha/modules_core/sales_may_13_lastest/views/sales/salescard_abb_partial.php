...
?>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" border="0">
    <tr>
      <td style="text-align: center; border-top: none; font-family:courier new; border-left: none; border-right: none; vertical-align: middle;">SABAH Nepal</td>
      <td style="width:30px;text-align:center">Phone #</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; width:30px; font-family:courier new;"><?php echo $bill_details->sc_phone1;?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align: center; border-top: none; border-left: none; border-right: none; vertical-align: middle;font-size:11px;font-family:courier new;">ABBREVIATED TAX INVOICE </td>
      <td>&nbsp;</td>
    </tr>
  </table>
  ...
  <table id="partdesc"  width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate;table-layout:fixed;">
    ...
    <tr>
      ...
      <th style="font-size: 13px; font-family:courier new; text-align: left; border-bottom:1px dashed #000 !important;border-top:1px dashed #000 !important; padding-top:2px; padding-bottom: 2px; padding-left:10px"><label>Sales Discount:</label></th>
    ...
    <tr style="height:auto;">
      ...
      <td style="font-size: 14px; text-align: left; font-family:courier new; border-width:0 0px!important;height:10px; padding-left:10px; padding-top:1px;overflow:hidden "><?php echo $bill_part->part_desc;?></td>

      <td style="font-size: 14px; text-align: left; font-family:courier new; border-width:0 0px!important;height:10px; padding-left:10px; padding-top:1px;overflow:hidden ">
             <?php 
                if(!empty($maker_details)){
                  echo $bill_part->sale_name;
                  if($bill_part->sale_deduction_type == 1){
                      echo "(".$bill_part->sale_deduction_value."%)";
                  }else if ($bill_part->sale_deduction_type==2) {
                      echo "(".sprintf('%.2f',($bill_part->sale_deduction_value)).")";
                  }
                }else{
                  echo "N/A";
                }
    ...
    <tr>
      <td colspan="5" style="font-size: 14px;border :0 none !important ; text-align: right; padding-left:10px; font-weight:bold ; font-family:courier new;" ><label>Service Charge: </label></td>
      <td style="font-size: 14px;border :0 none !important ; text-align: right; padding-left:10px;font-family:courier new;" id = 'discount'><label> &nbsp;</label></td>
    </tr>
    <tr>
