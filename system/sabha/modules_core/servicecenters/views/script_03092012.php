...
function saveServiceCenter(){
	...
	var params="sc_id="+sc_id+"&sc_name="+sc_name+"&sc_address="+sc_address+"&sc_phone1="+sc_phone1+"&sc_phone2="+sc_phone2+"&sc_phone3="+sc_phone3+"&sc_fax="+sc_fax+"&sc_email="+sc_email+"&city_id="+city_id+"&unq="+ajaxunq();
	$.ajax({			
			type	:	"POST",
