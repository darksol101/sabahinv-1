...
<table style="width:50%" cellpadding="0" cellspacing="0" class="tblgrid"><col width="1%" /><col /><col width="15%" /><col width="15%" /><thead><tr><th>S.No.</th><th>Model Number</th><th></th></tr></thead><tbody><?php
	$i=1;
	foreach ($servicemanuals as $svm){
	$trstyle=$i%2==0?" class='even' ": " class='odd' ";
	?><tr <?php echo $trstyle;?>><td><?php echo $i;?></td><td><?php echo $svm->model_number;?></td><td><a class="btn" onclick="downloadManual('<?php echo $svm->model_id;?>')"><?php echo icon('download','Click to download','png');?></a></td></tr>
<?php $i++;}?>
